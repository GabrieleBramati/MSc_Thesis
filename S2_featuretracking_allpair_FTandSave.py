...
for i in range (33):
    max_expected_disp_pix_x2_single = max_expected_disp_pix[i]*2
...
for i in range(34): #images are 34
    ft_pair = templatematch(imported_img[i], imported_img[i+1], pu=pu, pv=pv, TemplateWidth=11, SearchWidth= 11+ max_expected_disp_pix_x2[i])
...
#save df_pu
xls_path = 'C:/Users/39333/OneDrive - Universitetet i Oslo/Oslo_University/MSc_Thesis/Processed_data/Output_featuretracking_raw_adaptivesearch_6md_x2/df_pu_allpairs.xlsx'
save_xls(df_pu, xls_path)
del xls_path

#save df_pv
xls_path = 'C:/Users/39333/OneDrive - Universitetet i Oslo/Oslo_University/MSc_Thesis/Processed_data/Output_featuretracking_raw_adaptivesearch_6md_x2/df_pv_allpairs.xlsx'
save_xls(df_pv, xls_path)
del xls_path

#save df_du
xls_path = 'C:/Users/39333/OneDrive - Universitetet i Oslo/Oslo_University/MSc_Thesis/Processed_data/Output_featuretracking_raw_adaptivesearch_6md_x2/df_du_allpairs.xlsx'
save_xls(df_du, xls_path)
del xls_path

#save df_dv
xls_path = 'C:/Users/39333/OneDrive - Universitetet i Oslo/Oslo_University/MSc_Thesis/Processed_data/Output_featuretracking_raw_adaptivesearch_6md_x2/df_dv_allpairs.xlsx'
save_xls(df_dv, xls_path)
del xls_path

#save df_meanAbsCorr
xls_path = 'C:/Users/39333/OneDrive - Universitetet i Oslo/Oslo_University/MSc_Thesis/Processed_data/Output_featuretracking_raw_adaptivesearch_6md_x2/df_meanAbs_Corr_allpairs.xlsx'
save_xls(df_meanAbs_Corr, xls_path)
del xls_path

#save df_peakCorr
xls_path = 'C:/Users/39333/OneDrive - Universitetet i Oslo/Oslo_University/MSc_Thesis/Processed_data/Output_featuretracking_raw_adaptivesearch_6md_x2/df_peakCorr_allpairs.xlsx'
save_xls(df_peakCorr, xls_path)
del xls_path

#save df_snr
xls_path = 'C:/Users/39333/OneDrive - Universitetet i Oslo/Oslo_University/MSc_Thesis/Processed_data/Output_featuretracking_raw_adaptivesearch_6md_x2/df_snr_allpairs.xlsx'
